...
do
  ...
  then
    ...
    echo "$(tail -7000 logs/${key}_report.log)" > "logs/${key}_report.log"
  else
...
then
  ...
  git config --global user.name 'dev-jacob-prog'
  git config --global user.email 'hafeezhafeez779@gmail.com'
